...
github.com/weave-lab/pgx/stdlib to use pgx as a database/sql compatible driver.
...
pgx uses the github.com/weave-lab/pgx/pgtype library to support more types. See
